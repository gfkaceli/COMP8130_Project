...
# ---------------------------
dataset_file = "../my_data/extracted_java_data.json"
...
sample_count = 0
for sample in samples[:20]:  # Process first 20 samples for debugging.
...
output_graphml_file = "global_java_variable_dependency_graph.graphml"
nx.write_graphml(global_vdg, output_graphml_file)
logger.info(f"Global Java VDG saved as GraphML: {output_graphml_file}")
